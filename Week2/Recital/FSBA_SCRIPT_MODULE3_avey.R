...
## Better
tempdata$rankSatis = 21 - as.numeric(cut(tempdata$S, breaks = seq(0, 1, length.out = 21)))
...
area <- cntbSatisRank$left
radius <- sqrt(area / pi)

## Wrong
symbols(aggbSatisRank$rankSatis,aggbSatisRank$left,circles=area, inches=.2, fg="white", bg="red",main= "Satisfaction and Employee Attrition", ylab="Average Attrition Rate", xlab= "Rank of Satisfaction")
